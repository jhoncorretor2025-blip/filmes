const state = { filmes: [], busca: '', genero: 'Todos', ordenacao: 'destaque' };
const $ = s => document.querySelector(s);
const movieGrid = $('#movieGrid'), emptyState = $('#emptyState'), resultsInfo = $('#resultsInfo');
const searchInput = $('#searchInput'), clearSearch = $('#clearSearch'), genreFilter = $('#genreFilter'), sortFilter = $('#sortFilter');
const genreCards = $('#genreCards'), modal = $('#movieModal'), modalContent = $('#modalContent'), navLinks = $('#navLinks');
...
if(navLinks&&$('#mobileMenu')){$('#mobileMenu').addEventListener('click',()=>navLinks.classList.toggle('open'));navLinks.addEventListener('click',()=>navLinks.classList.remove('open'));}
carregarFilmes();
